...
public class ContactosCovid {
	...
	public void loadData(String data, boolean reset) throws EmsInvalidTypeException, EmsInvalidNumberOfDataException,
		...
		rellenarInfoContactos(datas);
	}

	private void rellenarInfoContactos(String[] datas) throws EmsInvalidTypeException, EmsInvalidNumberOfDataException, EmsDuplicatePersonException, EmsDuplicateLocationException {
